...
+
*Web*,*Rest Repositories*, *JPA*, *H2*, and *Actuator*

. Click the _Generate Project_ button. Your browser will download a zip file.

. Copy then unpack the downloaded zip file to *cloud-native-workshop/labs/my_work/cloud-native-spring*
+
...
*_STS Import Help:_*
+
Select File > Import… Then select Maven > Existing Maven Projects. On the Import Maven Projects page, browse to the /cloud-native-spring directory (e.g. cloud-native-spring/labs/my_work/cloud-native-spring)
...
. In a terminal, change working directory to *cloud-native-workshop/labs/my_work/cloud-native-spring*
+
$ cd /cloud-native-workshop/labs/my_work/cloud-native-spring
